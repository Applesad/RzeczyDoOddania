...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryItem", b =>
                {
                    ...
                    b.ToTable("CategoryItem", "Identity");
                });
            ...
            modelBuilder.Entity("RzeczyDoOddania.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RzeczyDoOddania.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RzeczyDoOddania.Models.UserItem", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RzeczyDoOddania.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RzeczyDoOddania.Models.Item", b =>
                {
                    b.HasOne("RzeczyDoOddania.Models.ApplicationUser", "Owner")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("RzeczyDoOddania.Models.UserItem", b =>
                {
                    ...
                    b.HasOne("RzeczyDoOddania.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
